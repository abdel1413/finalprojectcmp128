...
let author, participant, strudent;
...
if((document.getElementById("level_1").checked == true) && coupon ==="Lehman College" ){
...
if((document.getElementById("level_2").checked == true) &&(coupon ==="Lehman College")){
...
if((document.getElementById("level_3").checked == true) &&(coupon ==="Lehman College")){

strudent = document.createElement("p");
strudent.innerHTML = "Amount Due: $" + 100/2 + ".";
total.appendChild(strudent);
clearInputField();

} else if(document.getElementById("level_3").checked == true){

    strudent = document.createElement("p");
    strudent.innerHTML = "Amount Due: $" + 100 + ".";
    total.appendChild(strudent);
    clearInputField();
...
function doesContainNumbers(num){
    if((num.indexOf("9") >= 0)||(num.indexOf("8")>=0)||
        (num.indexOf("7") >= 0)||(num.indexOf("6") >= 0 )||
        (num.indexOf("5") >= 0 )||(num.indexOf("4") >= 0 )||
        (num.indexOf("3") >= 0 )||(num.indexOf("2") >= 0 )||
        (num.indexOf("1") >= 0 )||(num.indexOf("0") >= 0 )){
        return true
    }else{
        return false
    }
